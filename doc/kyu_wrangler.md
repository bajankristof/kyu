...
<pre><code>
await(Name::<a href="kyu_consumer.md#type-name">kyu_consumer:name()</a>) -&gt; ok
</code></pre>
<br />
...
<pre><code>
await(Name::<a href="kyu_consumer.md#type-name">kyu_consumer:name()</a>, Timeout::timeout()) -&gt; ok
</code></pre>
<br />
...
<pre><code>
channel(Name::<a href="kyu_consumer.md#type-name">kyu_consumer:name()</a>) -&gt; pid() | undefined
</code></pre>
<br />
...
<pre><code>
connection(Name::<a href="kyu_consumer.md#type-name">kyu_consumer:name()</a>) -&gt; term()
</code></pre>
<br />
...
<pre><code>
queue(Name::<a href="kyu_consumer.md#type-name">kyu_consumer:name()</a>) -&gt; binary()
</code></pre>
<br />
